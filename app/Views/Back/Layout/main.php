...
<head>
    ...
    <!-- Espaço reservado para apresentar css especifico das views que extendem esse template-->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo route_to('dentistas') ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php echo $this->include('Back/Layout/_messages.php'); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Deseja fazer o logout?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    Selecione "logout" abaixo se você quiser encerrar sua seção</div>
    ...
    <!-- Espaço reservado para scripts especificos das views que extendem esse template-->
